...
class GitlabHelper(object):
    ...
    def __init__(self, url, token, timeout, groups, namespace_granularity, namespace_admin):
        self.client = None
        self.gitlab_users = []
        self.groups = groups
        ...
        self.namespace_admin = namespace_admin
        self.namespaces = []
    ...
    def get_admins(self):
        ...
        """
        try:
            if self.namespace_admin:
                ns = self.client.groups.list(search=self.namespace_admin)
...
def main():
    try:
        ...
        GITLAB_NAMESPACE_ADMIN = environ.get("GITLAB_NAMESPACE_ADMIN", None)
        ...
        while True:
            gitlab_helper = GitlabHelper(
                ...
                namespace_admin=GITLAB_NAMESPACE_ADMIN
            )
